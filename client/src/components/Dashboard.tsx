...
function Dashboard() {
    ...
    const handleMenuClick = () => history.push('/dashboard');
        ...
        <div className='grid-container'>
            ...
            <aside className={isActive ? 'sidenav  active' : 'sidenav '}>
                ...
                <ul className='sidenav__list' >
                    <li className='sidenav__list-item' onClick={() => history.push('/reports/performance')}>Performance report</li>
            ...
            <main className='main '>
                ...
                <div className='main_cards'>
                    <div className='card'><ReportPerformance /></div>
